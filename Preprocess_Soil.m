...
files = ncinfo('C:\PhyloTraitEst\GIS\TerraClimate19912020_soil.nc');
lat = ncread('C:\PhyloTraitEst\GIS\TerraClimate19912020_soil.nc','lat');
lon = ncread('C:\PhyloTraitEst\GIS\TerraClimate19912020_soil.nc','lon');
VPD = ncread('C:\PhyloTraitEst\GIS\TerraClimate19912020_soil.nc','soil');
